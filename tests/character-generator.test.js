...
test("aplica bônus de PV de Mul e Meio-Gigante", () => {
  assert.equal(hitPointBonusForRace({ name: "Mul" }), 1);
  assert.equal(hitPointBonusForRace({ name: "Meio-Gigante Athasiano" }), 2);
});
