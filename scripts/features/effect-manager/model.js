...
export const CONDITIONAL_VALUE_DEFINITIONS = Object.freeze([
  ...
  ["attack.itemNamed", "Ataque usa a arma/item informado", "Ataque atual", "all"], ["attack.rangedItemNamed", "Ataque à distância usa a arma informada", "Ataque atual", "all"],
...
const BOOLEAN_CONDITIONAL_VALUES = new Set([
  ...
  "item.container", "item.magic", "attack.itemNamed", "attack.rangedItemNamed", "attack.weaponMelee", "attack.weaponRanged",
...
export function conditionalValue(snapshot, operand, rule = {}) {
  ...
  const namedCollections = {
    ...
    "effect.inactive": snapshot.inactiveEffects, "attack.itemNamed": snapshot.attackItems, "attack.rangedItemNamed": snapshot.rangedAttackItems,
